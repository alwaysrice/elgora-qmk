...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LAYER_QWERTY] = LAYOUT(
        ...
        KC_SPC,		MOUSE,		KC_LEFT,	KC_RIGHT,	KC_TAB,																KC_TAB,		KC_RIGHT,	KC_LEFT,	KC_TAB,		KC_SPC,
    ...
    [LAYER_FUNC] = LAYOUT(
        KC_PSCR,	KC_F1,		KC_F2,		KC_F3,		KC_F4,		KC_F5,		KC_6,				_______,	_______,	_______,	_______,	_______,	_______,	_______,
        _______,	KC_F7,		KC_F8,		KC_F9,		KC_F10,		KC_F11,		KC_F12,				_______,	_______,	_______,	_______,	_______,	_______,	_______,
        _______,	LCA(KC_F1),	LCA(KC_F2),	LCA(KC_F3),	LCA(KC_F4),	LCA(KC_F5),	LCA(KC_F6),			_______,	_______,	_______,	_______,	_______,	_______,	_______,
        _______,	LCA(KC_F7),	LCA(KC_F8),	LCA(KC_F9),	LCA(KC_F10),LCA(KC_F11),								_______,	_______,	_______,	_______,	_______,	_______,
        _______,	_______,	_______,	_______,	_______,															_______,	_______,	_______,	_______,	_______,
        _______,	_______,	_______,	_______,																					_______,	_______,	_______,	_______
    ),
    [LAYER_MOUSE] = LAYOUT(
